This is a sample application designed for Comp assignment where it was requested to have a simple UI to show Surveys and a user can select to fill that survey and submit.
## Table of Contents
...
* It is highly recommended to implement CDC testing for production

## Entities

To keep all the data in relational form, a very broad approach has been used here where the main entity is Survey
`https://localhost:44369/surveys/5849b0e7-87b7-4f12-ac05-101a325c85a8/submission` is a global command-line utility that you use to create new projects.
